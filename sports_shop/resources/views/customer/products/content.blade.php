...
<!-- Link chỉ mục chi tiết -->
<div class="container p-t-84 con-pa-top">
...
<section class="sec-product-detail bg0 p-t-65 p-b-60">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-7 p-b-30">
...
<section class="sec-relate-product bg0 p-t-45 p-b-105">
    ...
    <button class="arrow-slick2 next-slick2 slick-arrow" aria-disabled="false" style=""><i class="fa fa-angle-right"
